...
// Firebase integration (ES Module syntax not supported in traditional scripts, so using CDN-based legacy method)
...
async function loadArtworksFromFirebase() {
  ...
  querySnapshot.forEach((doc) => {
    ...
    item.className = `art-item ${data.category}`;
    item.innerHTML = `
      <div class="art-img">
      ...
      <span class="art-category">${data.category}</span>
    `;
